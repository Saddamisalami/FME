...
void drawAlarmPageType_v(TFT_eSPI &, TFT_eSprite &, int);

void drawAlarmPageDetail_v(TFT_eSPI &, TFT_eSprite &, boolean, int);

void scrollAlarmText_v(TFT_eSPI &, TFT_eSprite &, String);